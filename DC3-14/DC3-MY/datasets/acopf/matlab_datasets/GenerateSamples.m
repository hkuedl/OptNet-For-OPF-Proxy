...
%% Include libraries
addpath(genpath('C:/Program Files/MATLAB/R2022b/toolbox/matpower7.1'));
...
my_model = case14;
my_model.gen(1,9) = 100;
my_model.gen(2,9) = 100;
my_model.gen(3,9) = 80;
my_model.gen(4,9) = 60;
my_model.gen(5,9) = 60;
...
for t = 1:NSamples
    ...
    if (rem(t, 1000) == 0)
        % Save Data
        save('FeasiblePairs_Case14.mat', 'Dem', 'Gen', 'Vol', 'Ybus', 'EPS_INTERIOR', ...
